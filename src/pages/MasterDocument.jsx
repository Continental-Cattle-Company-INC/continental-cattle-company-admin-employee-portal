...
const SECTIONS = [
  ...
  {
    category: 'DOWNSTREAM ENGINES (801–900)', sections: [
      { num: 801, title: 'Packer Behavior Engine', content: 'Tracks packer bidding behavior, kill schedules, capacity shifts, and procurement timing.\nInputs: Packer bids, kill schedules, capacity data, cutout data.\nOutputs: Packer behavior score, packer behavior forecast, packer behavior strategy.' },
      { num: 802, title: 'Packer Fusion Engine', content: 'Fuses packer behavior with cutout, trim, export demand, and cold storage.\nInputs: Packer data, cutout data, trim data, export demand.\nOutputs: Packer fusion score, packer fusion map, packer fusion strategy.' },
      { num: 803, title: 'Packer Simulation Engine', content: 'Simulates packer slowdowns, labor shortages, kill surges, and export shifts.\nInputs: Historical packer data, scenario assumptions.\nOutputs: Packer simulation outcomes, packer simulation risk, packer simulation optimization.' },
      { num: 804, title: 'Packer Control Tower', content: 'Provides unified command over marketing timing, grid selection, and delivery alignment.\nInputs: Packer forecasts, grid data.\nOutputs: Packer command plan, packer command optimization.' },
      { num: 805, title: 'Processor Behavior Engine', content: 'Tracks fabrication shifts, yield optimization, labor constraints, and product mix changes.\nInputs: Fabrication data, yield data, labor data.\nOutputs: Processor behavior score, processor behavior forecast, processor behavior strategy.' },
      { num: 806, title: 'Processor Fusion Engine', content: 'Fuses processor behavior with cutout, retail demand, and export demand.\nInputs: Processor data, cutout data, retail data.\nOutputs: Processor fusion score, processor fusion map, processor fusion strategy.' },
      { num: 807, title: 'Processor Simulation Engine', content: 'Simulates fabrication bottlenecks, labor shortages, and product mix shifts.\nInputs: Historical processor data, scenario assumptions.\nOutputs: Processor simulation outcomes, processor simulation risk, processor simulation optimization.' },
      { num: 808, title: 'Processor Control Tower', content: 'Provides unified command over delivery timing, product mix alignment, and yield optimization.\nInputs: Processor forecasts, yield data.\nOutputs: Processor command plan, processor command optimization.' },
      { num: 809, title: 'Cutout Engine 2.0', content: 'Tracks rib, loin, chuck, round, and trim interactions to forecast cutout volatility.\nInputs: Cutout data, retail promotions, export demand.\nOutputs: Cutout score, cutout forecast, cutout strategy.' },
      { num: 810, title: 'Cutout Fusion Engine 2.0', content: 'Fuses cutout with retail, foodservice, and export demand.\nInputs: Cutout data, retail data, foodservice data.\nOutputs: Cutout fusion score, cutout fusion map, cutout fusion strategy.' },
      { num: 811, title: 'Cutout Simulation Engine 2.0', content: 'Simulates holiday demand, seasonal shifts, and export surges.\nInputs: Historical cutout, scenario assumptions.\nOutputs: Cutout simulation outcomes, cutout simulation risk, cutout simulation optimization.' },
      { num: 812, title: 'Cutout Control Tower 2.0', content: 'Provides unified command over marketing, grid selection, and delivery timing.\nInputs: Cutout forecasts, grid data.\nOutputs: Cutout command plan, cutout command optimization.' },
      { num: 813, title: 'Trim Engine 2.0', content: 'Tracks 50s, 65s, 75s, domestic 90s, and imported 90s trim markets.\nInputs: Trim data, cow kill, import flows.\nOutputs: Trim score, trim forecast, trim strategy.' },
      { num: 814, title: 'Trim Fusion Engine 2.0', content: 'Fuses trim with cow kill, import flows, and retail grind demand.\nInputs: Trim data, cow kill, import data.\nOutputs: Trim fusion score, trim fusion map, trim fusion strategy.' },
      { num: 815, title: 'Trim Simulation Engine 2.0', content: 'Simulates import surges, cow kill spikes, and retail grind demand shifts.\nInputs: Historical trim data, scenario assumptions.\nOutputs: Trim simulation outcomes, trim simulation risk, trim simulation optimization.' },
      { num: 816, title: 'Trim Control Tower 2.0', content: 'Provides unified command over trim marketing, timing, and grid selection.\nInputs: Trim forecasts, grid data.\nOutputs: Trim command plan, trim command optimization.' },
      { num: 817, title: 'Retail Engine', content: 'Tracks retail beef prices, promotions, movement, and margins.\nInputs: Retail prices, promotions, movement data.\nOutputs: Retail score, retail forecast, retail strategy.' },
      { num: 818, title: 'Retail Fusion Engine', content: 'Fuses retail with cutout, foodservice, and consumer sentiment.\nInputs: Retail data, cutout data, consumer sentiment.\nOutputs: Retail fusion score, retail fusion map, retail fusion strategy.' },
      { num: 819, title: 'Retail Simulation Engine', content: 'Simulates holiday demand, seasonal promotions, and economic downturns.\nInputs: Historical retail data, scenario assumptions.\nOutputs: Retail simulation outcomes, retail simulation risk, retail simulation optimization.' },
      { num: 820, title: 'Retail Control Tower', content: 'Provides unified command over retail marketing, timing, and product mix alignment.\nInputs: Retail forecasts, cutout data.\nOutputs: Retail command plan, retail command optimization.' },
      { num: 900, title: 'Downstream Master Completion', content: 'Confirms completion and integration of the 801–900 downstream, packer, processor, retail, and multi-species tier.\nInputs: All downstream engines, all fusion engines, all control towers.\nOutputs: Downstream completion status, downstream integration score, downstream readiness.' },
    ]
  },
  {
    category: 'GLOBAL ENGINES (901–1000)', sections: [
      { num: 901, title: 'Geopolitical Engine', content: 'Tracks geopolitical forces affecting protein markets including conflicts, alliances, sanctions, and border disruptions.\nInputs: Conflict data, trade alliances, sanctions, border activity.\nOutputs: Geopolitical score, geopolitical forecast, geopolitical strategy.' },
      { num: 902, title: 'Geopolitical Fusion Engine', content: 'Fuses geopolitics with trade flows, currency, logistics, and export demand.\nInputs: Geopolitical data, trade data, currency data, logistics data.\nOutputs: Geopolitical fusion score, geopolitical fusion map, geopolitical fusion strategy.' },
      { num: 903, title: 'Geopolitical Simulation Engine', content: 'Simulates war, embargoes, border closures, and sanction cascades.\nInputs: Historical geopolitical data, scenario assumptions.\nOutputs: Geopolitical simulation outcomes, geopolitical simulation risk, geopolitical simulation optimization.' },
      { num: 904, title: 'Geopolitical Control Tower', content: 'Provides unified command over export timing, import substitution, and logistics rerouting.\nInputs: Geopolitical forecasts, trade flows.\nOutputs: Geopolitical command plan, geopolitical command optimization.' },
      { num: 905, title: 'National Security Engine', content: 'Tracks protein-security threats including cyber risks, infrastructure vulnerabilities, and supply chain attacks.\nInputs: Cyber data, infrastructure data, threat intelligence.\nOutputs: Security score, security forecast, security strategy.' },
      { num: 906, title: 'National Security Fusion Engine', content: 'Fuses national security with logistics, processing, cold storage, and trade.\nInputs: Security data, logistics data, processing data.\nOutputs: Security fusion score, security fusion map, security fusion strategy.' },
      { num: 907, title: 'National Security Simulation Engine', content: 'Simulates cyber breaches, infrastructure attacks, and transport shutdowns.\nInputs: Historical security data, scenario assumptions.\nOutputs: Security simulation outcomes, security simulation risk, security simulation optimization.' },
      { num: 908, title: 'National Security Control Tower', content: 'Provides unified command over risk mitigation, infrastructure hardening, and cyber defense.\nInputs: Security forecasts, infrastructure data.\nOutputs: Security command plan, security command optimization.' },
      { num: 909, title: 'Global Trade Engine 2.0', content: 'Tracks global protein trade flows including beef, pork, poultry, dairy, and aquaculture.\nInputs: Export data, import data, currency data.\nOutputs: Trade score, trade forecast, trade strategy.' },
      { num: 910, title: 'Global Trade Fusion Engine 2.0', content: 'Fuses global trade with currency, logistics, and geopolitics.\nInputs: Trade data, currency data, geopolitical data.\nOutputs: Trade fusion score, trade fusion map, trade fusion strategy.' },
      { num: 911, title: 'Global Trade Simulation Engine 2.0', content: 'Simulates tariff wars, export bans, and port shutdowns.\nInputs: Historical trade data, scenario assumptions.\nOutputs: Trade simulation outcomes, trade simulation risk, trade simulation optimization.' },
      { num: 912, title: 'Global Trade Control Tower 2.0', content: 'Provides unified command over export timing, import substitution, and logistics.\nInputs: Trade forecasts, logistics data.\nOutputs: Trade command plan, trade command optimization.' },
      { num: 913, title: 'Global Food Security Engine', content: 'Tracks global food security conditions including protein shortages and supply chain failures.\nInputs: Protein supply, grain supply, logistics data.\nOutputs: Food security score, food security forecast, food security strategy.' },
      { num: 914, title: 'Global Food Security Fusion Engine', content: 'Fuses food security with weather, geopolitics, and trade.\nInputs: Food security data, weather data, geopolitical data.\nOutputs: Food security fusion score, food security fusion map, food security fusion strategy.' },
      { num: 915, title: 'Global Food Security Simulation Engine', content: 'Simulates global famine, protein shortages, and grain collapses.\nInputs: Historical food security data, scenario assumptions.\nOutputs: Food security simulation outcomes, food security simulation risk, food security simulation optimization.' },
      { num: 916, title: 'Global Food Security Control Tower', content: 'Provides unified command over export allocation, domestic prioritization, and emergency logistics.\nInputs: Food security forecasts, logistics data.\nOutputs: Food security command plan, food security command optimization.' },
      { num: 917, title: 'Global Supply Chain Engine 2.0', content: 'Tracks global supply chain conditions including ports, rail, highways, and cold chain.\nInputs: Port data, rail data, highway data.\nOutputs: Supply chain score, supply chain forecast, supply chain strategy.' },
      { num: 918, title: 'Global Supply Chain Fusion Engine 2.0', content: 'Fuses supply chain with weather, geopolitics, and energy.\nInputs: Supply chain data, weather data, energy data.\nOutputs: Supply chain fusion score, supply chain fusion map, supply chain fusion strategy.' },
      { num: 919, title: 'Global Supply Chain Simulation Engine 2.0', content: 'Simulates port shutdowns, fuel spikes, and labor strikes.\nInputs: Historical supply chain data, scenario assumptions.\nOutputs: Supply chain simulation outcomes, supply chain simulation risk, supply chain simulation optimization.' },
      { num: 920, title: 'Global Supply Chain Control Tower 2.0', content: 'Provides unified command over routing, scheduling, and contingency planning.\nInputs: Supply chain forecasts, logistics data.\nOutputs: Supply chain command plan, supply chain command optimization.' },
      { num: 1000, title: 'Global Sovereign Master Completion', content: 'Confirms full completion and integration of all 1,000 engines, fusion engines, simulations, and control towers.\nInputs: All engines, all fusion engines, all simulations, all control towers.\nOutputs: Global sovereign completion status, total system integration score, enterprise readiness confirmation.' },
    ]
  },
  {
