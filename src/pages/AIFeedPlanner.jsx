...
${transitInfo}
${mileageResult ? `- NOTE: Adjust arrival processing protocol based on transit stress — longer hauls require more aggressive receiving protocol (electrolytes, light roughage, BRD monitoring window extended)` : ''}
